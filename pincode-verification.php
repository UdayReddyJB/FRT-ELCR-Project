...
<head>
    ...
    <title>Student EC Pincode Verification</title>
 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Student Enrolled Course Pincode Verification</h1>
                    </div>
                </div>
                <div class="row" >
...
<font color="red" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
   ...
   <div class="form-group">
    <label for="pincode">Enter EC Pincode</label>
